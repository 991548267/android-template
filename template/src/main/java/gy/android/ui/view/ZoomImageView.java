...
public class ZoomImageView extends AppCompatImageView implements ViewTreeObserver.OnGlobalLayoutListener {
    ...
    private Point layoutSize = new Point();
    ...
    public void onGlobalLayout() {
        if (mIsOneLoad) {
            ...
            if (layoutSize.x != width || layoutSize.y != height
                    || imageSize.x != dw || imageSize.y != dh) {
                layoutSize.x = width;
                layoutSize.y = height;
                imageSize.x = dw;
                imageSize.y = dh;
...
//                setImageMatrix(mScaleMatrix);
                ...
                scaleAnimation(mInitScale, translationX, translationY);
                // }
                LogUtil.v(ZoomImageView.this, "onGlobalLayout size(" + width + "," + height + ") image size(" + dw + "," + dh + ")");
            }
//            mIsOneLoad = false;
        }
    }
