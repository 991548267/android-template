...
import gy.android.R;
import gy.android.constant.PermissionConstants;
...
public class PermissionUtil {
    ...
    public static PermissionUtil withContext(Context context) {
     ...
     */
    public PermissionUtil permission(final String... permissions) {
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(this.context, PermissionActivity.TYPE_RUNTIME);
    }
    ...
    public static class PermissionActivity extends Activity {
        ...
        protected void onActivityResult(int requestCode, int resultCode, Intent data) {
            if (requestCode == TYPE_WRITE_SETTINGS) {
                ...
                if (isGrantedWriteSettings(sInstance.context)) {
                ...
                handler.postDelayed(() -> {
                    if (isGrantedDrawOverlays(sInstance.context)) {
    ...
    public static void showRationaleDialog(Activity activity, OnRationaleListener.ShouldRequest request) {
        ...
        builder.setTitle(android.R.string.dialog_alert_title)
                ...
                .setNegativeButton(android.R.string.cancel, (dialog, which) -> request.again(false))
                .setCancelable(false)
                .create().show();
    }
